...
let username: string = "Abdulkadir Developer";
...
let names: string[] = ["Oscar", "Adriana", "Ahmed Alo", "Jelle", "Taco"];

console.log(names.map(name => name.toUpperCase()));

// tuple

let person: [string, number] = ["sam Altman", 30];
...
console.log(greet("Abdulkadir Mohamud 😍"));
...
console.log(createGreeting('Abdulkadir'))
console.log(createGreeting('Mohamud', 30))
...
// let user: User = { name: "Abdulkadir", age: 30 }
// let user2: User = { name: "Abdulkadir", age: 30 }
// let user3: User = { name: "Abdulkadir", age: 30 }
...
const newPerson: Person = { name: "Abdulkadir", age: 20 }

// ### 4. Nullable Types and Optional Chaining


const userInfo = { profile: { name: 'Olga', age: 30 } };
...
// console.log(contain([1, 2, 3], "Abdulkadir"))
...
const stringPair: Pair<string, string> = { first: "AbDL", second: "AL" }
